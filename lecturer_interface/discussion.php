...
$display =  <<<block
<form method = "POST" name = "discussion_form" action = "$_SERVER[PHP_SELF]" >
$select_result
<br />
<label for = "type_of_discussion">Discussion type</label>
<select name = "type">
<option name = "select_type" selected = "selected">Select type</option>
<option value = "open">Open</option>
<option value = "close">Close</option>
</select><br />
<label for = "discussion_topic" >Discussion Topic</label><br />
<textarea name = "discussion_topic" rows = "7" cols = "50"></textarea><br />
<input type = "submit" value = "Create" class = "inner_btns" id = "createDiscussion" name = "create_discussion" />
<input type = "submit" value = "View discussions" class = "inner_btns" id = "viewDiscussions" name = "view_discussions" />
</form>
block;
}
}		//discussion
...
if(isset($_POST["view_discussions"])){
...
$table_values
<input type = "submit" class = "inner_btns" id = "viewPosts" name = "view_posts" value = "View Posts" />
</form>
<a id = "getDiscussionForm" href = "$_SERVER[PHP_SELF]?discussion=yes">Create Discussion</a>
block;
}
}
}
...
$table_values 
<input type = "submit" class = "inner_btns" id = "gradeStudent" name = "grade_student" value = "Grade Student" />
</form>
block;
}
}
