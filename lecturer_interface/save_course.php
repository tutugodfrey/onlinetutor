...
$action = "<input type = \"submit\" class = \"inner_btns\" id = \"updateCourse\" name = \"update_course\" value = \"Update\" />";
$view_courses = "<a href = \"$_SERVER[PHP_SELF]?&view_courses=yes\" id = \"viewCourses\">View courses</a>";
}
}
}
...
$course_code = "<label for = \"course_code\">Course Code</label><input type = \"text\" name = \"course_code\" />";
$course_title .= "<input type = \"text\" name = \"course_title\" />";
$course_description .= "<textarea name = \"course_description\" cols = \"50\" rows = \"7\"></textarea>";
$course_unit .= "<input type = \"number\" name = \"course_unit\" />";
$action = "<input type = \"submit\" class = \"inner_btns\" id = \"save\" name = \"save_course\" value = \"SAVE\" />";
$view_courses = "<a href = \"$_SERVER[PHP_SELF]?&view_courses=yes\" id = \"viewCourses\">View courses</a>";
}
 

$display .= <<<end
<form method = "POST" name= "form1" action = "$_SERVER[PHP_SELF]" id = "my_form" >
$course_code <br/>
$course_title<br />
...
$display .= "<input type = \"submit\" class = \"inner_btns\" id = \"deleteCourse\" name = \"delete_course\" value = \"DELETE\" />";
$display .= "<input type = \"submit\" class = \"inner_btns\" id = \"editCourse\" name = \"edit_course\" value = \"EDIT\" />";
$display .= "</form>";
$display .= "<p>You want to <a href = \"$_SERVER[PHP_SELF]?save_courses=yes\" id = \"saveCourse\" >add a course</a></p>";
}
}
