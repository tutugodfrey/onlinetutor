...
if(isset($_POST["edit"]) || isset($_GET["set_questions"])){
	...
	$optionA = "<label for = \"options\">A</label><input type = \"checkbox\" class = \"form-control correctOption \" name = \"correct[]\" value = \"A\"/>";
	$optionB = "<label for = \"options\">B</label><input type = \"checkbox\" class = \"form-control correctOption\"  name = \"correct[]\"  value = \"B\"/>";
	$optionC = "<label for = \"options\">C</label><input type = \"checkbox\" class = \"form-control correctOption\"  name = \"correct[]\"  value = \"C\"/>";
	$optionD = "<label for = \"options\">D</label><input type = \"checkbox\" class = \"form-control correctOption\"  name = \"correct[]\" value = \"D\" />";
	...
	if($course_id == ""){
		...
		if($row_num2 == 0 ){
			...
			if($row_num2 == 0){
				...
				$table_values
				<input type = "submit" class = "btn btn-success" id = "editQuestion" name = "edit" value = "Edit Question" />
				<input type = "submit" class = "btn btn-danger" id = "deleteQuestion" name = "delete" value = "Delete" />
block;
			}
		}
	}
