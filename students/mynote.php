...
<input type = \"submit\" class = \"inner_btns\" id = \"editNote\" name = \"edit_note\" value = \"Edit\" />
<br /><br />";
}
...
$course_code2 = get_course_code($lecturer_db, $hcourse_id);
...
<input type = "submit" class = "inner_btns" id = "editNote" name = "edit" value = "Back" />
</p>
</form>
block;
exit();
...
<input type = "hidden" name = "note_id" value = "$note_id" />
<input type = "hidden" name = "course_id" value = "$course_id" />
<input type = "submit" class = "inner_btns" id = "continueEdit" name = "edit" value = "Continue" />
</form>
block;
}
}
