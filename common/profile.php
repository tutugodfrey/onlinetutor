...
/*
if($class == "lecturer") {
$query_string = "select picture, firstname, lastname, gender, birthday, title, faculty, department, email, phone from registered_users where id = \"$user_id\"";
$fields = array ("picture", "lastname", "firstname", "gender", "date of birth", "title", "faculty", "department", "email", "phone");
}
*/
...
<input type = "submit" class = "inner_btns" id = "updateProfile" name = "update_profile" value = "Update" />
</form>
<pre class = "nojs_show">
...
if(isset($_POST["update_profile"]) || isset($_POST["new_photo"]) || isset($_POST["date_of_birth"])) {
$class = $_POST["class"];
...
<label for = "newPhoto">Choose a new photo from file</label>
<input id = "newPhoto" type = "file" name = "photo" />
<input type = "submit" class = "inner_btns"  id = "photo_update" name = "new_photo" value = "Change" />
</form>
block;
exit;
...
$date_fields
<input type = "submit" class = "inner_btns" id = "update_birthday" name = "date_of_birth" value = "Change" />
</form>
block;
exit;
}	else	{
...
$new_value = "/mylecturerapp/personal_data/user$user_id/profile_pix/";
...
$new_value = "/mylecturerapp/personal_data/defaultpix.png";
$update_field = "picture";
}
}		//end $_POST[new_photo]
